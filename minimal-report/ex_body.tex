...
%\newcommand{\signaturesABImages}{%
%    \vspace*{4\baselineskip}
%	\begin{center}
%		\begin{minipage}{\textwidth}
%			\begin{tabbing}
%				\hspace{5.5cm}  \= \hspace{5.5cm}  \=  \\
%
...
%						\> \rule{4cm}{.1pt} \\
%		
%				\signatureAName \> \signatureBName \> \chiefMetrologistName \\
%				\signatureARole \> \signatureBRole \> \chiefMetrologistRole                
%			\end{tabbing}
%		\end{minipage}
%	\end{center}
%}
